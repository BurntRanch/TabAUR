...
tartype_t           gz_type = {(openfunc_t)gzopen_frontend, (closefunc_t)gzclose_frontend, (readfunc_t)gzread_frontend, (writefunc_t)gzwrite_frontend};
...
int gzopen_frontend(const char* pathname, int flags, mode_t mode) {
    ...
    switch (flags & O_ACCMODE) {
        ...
        case O_RDONLY:
            ...
            break;
        default:
        case O_RDWR: errno = EINVAL; return -1;
    }
